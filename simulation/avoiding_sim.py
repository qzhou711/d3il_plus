...
class Avoiding_Sim(BaseSim):
    ...
    def test_agent(self, agent):
        ...
        self.last_robot_c_pos = robot_c_pos.detach().cpu().clone()
        self.last_mode_encoding = mode_encoding.detach().cpu().clone()
        self.last_successes = successes.detach().cpu().clone()
